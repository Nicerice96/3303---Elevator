...
public class Payload {
     ...
     * A payload is the class representation of an elevator instruction that is read from a text file.
     ...
     */
    public Payload(int timestamp, Direction buttonDirection, int pickupFloor, int destinationFloor) {
